...
# # RNN 
# Use non-consecutive predictors. Skip = 24. Same hour of each day: 7 daily predictors to predict next 3. Smoothing window size 3. Predict steam given steam and day of year. Compare to RNN 224, 225.
