...
# # RNN 
# Restructured code. Smooth steam (3hr window mean). Compare to RNN 221.
# 
...
# 
# RMSE/mean = 0.54 (measured against the smoothed data). Predictions vary by day and 2 units by hour.
