...
# 
# Try fake data. Train on cycle of hours. Predict cycle of hours. We know that worked with no distractions. Now add back weather fields. Even one weather field (air temp) adds confusion. Decreasing # neurons per layer to 4 didn't help but increasing it to 16 did. The predictions are still kind of smoothed but at least they cycle.  
