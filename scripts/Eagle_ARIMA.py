...
# model = ARIMA(bldg_specific_steam, order=(2,1,2))
# results_ARIMA = model.fit()
# predictions = results_ARIMA.predict(start = len (bldg_specific_steam), end = len(bldg_specific_steam)+24*7, typ = 'levels'). rename ('ARIMA predictions')
# print(predictions)
#     #pd.DataFrame(pred)
