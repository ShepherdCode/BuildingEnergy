...
# # CNN 
# Here predict more than one hour at a time.  
# 
# Compare to Report1 CNN 108 where we predicted the next one hour with no smoothing. The only difference here is we predict the next 24 hours. The challenge was not appreciably harder. 
# 
# This only trained for 5 epochs. Don't use these results.
