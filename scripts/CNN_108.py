...
# # CNN 
# Here use no smoothing.  
# 
# Here is how the previous work may have been optimistic.
# We smoothed all the data before starting.
# But we should not smooth the steam values used to test accuracy!
# 
# Compare to Report1 CNN 107. The only difference is no smoothing. The job got harder and the RMSE increased.
